...
const CreatePlaybookRequest = Record({
  "title": Text,
  "taskGoal": Text,
  "steps": Vec(Step),
  "screenshot": ExternalBlob$1,
  "platformName": Text
});
const PlaybookId = Nat;
const Timestamp = Int;
...
Service({
  ...
  "createPlaybook": Func([CreatePlaybookRequest], [PlaybookId], []),
  "detectPlatform": Func([ExternalBlob$1], [Text], []),
  "generatePlaybook": Func(
    [ExternalBlob$1, Text, Text],
    [PlaybookId],
    []
  ),
  "getPlaybook": Func([PlaybookId], [Opt(Playbook)], ["query"]),
  "listPlaybooks": Func([], [Vec(Playbook)], ["query"]),
  "transform": Func(
    [TransformationInput],
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Step2 = IDL2.Record({
    "actionLabel": IDL2.Text,
    "icon": IDL2.Text,
    "description": IDL2.Text,
    "stepNumber": IDL2.Nat,
    "uiElement": IDL2.Opt(IDL2.Text)
  });
  const ExternalBlob2 = IDL2.Vec(IDL2.Nat8);
  const CreatePlaybookRequest2 = IDL2.Record({
    "title": IDL2.Text,
    "taskGoal": IDL2.Text,
    "steps": IDL2.Vec(Step2),
    "screenshot": ExternalBlob2,
    "platformName": IDL2.Text
  });
  const PlaybookId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const Playbook2 = IDL2.Record({
    "id": PlaybookId2,
    "title": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "createPlaybook": IDL2.Func([CreatePlaybookRequest2], [PlaybookId2], []),
    "detectPlatform": IDL2.Func([ExternalBlob2], [IDL2.Text], []),
    "generatePlaybook": IDL2.Func(
      [ExternalBlob2, IDL2.Text, IDL2.Text],
      [PlaybookId2],
      []
    ),
    "getPlaybook": IDL2.Func([PlaybookId2], [IDL2.Opt(Playbook2)], ["query"]),
    "listPlaybooks": IDL2.Func([], [IDL2.Vec(Playbook2)], ["query"]),
    "transform": IDL2.Func(
...
class Backend {
  ...
  async generatePlaybook(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
async function from_candid_Playbook_n15(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_Step_n18(_uploadFile, _downloadFile, value) {
...
async function to_candid_CreatePlaybookRequest_n8(_uploadFile, _downloadFile, value) {
  return await to_candid_record_n9(_uploadFile, _downloadFile, value);
}
async function to_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value) {
  return await _uploadFile(value);
}
function to_candid_Step_n11(_uploadFile, _downloadFile, value) {
...
function to_candid_vec_n10(_uploadFile, _downloadFile, value) {
