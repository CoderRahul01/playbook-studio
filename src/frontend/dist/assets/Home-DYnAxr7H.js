...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, a as noop$1, b as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, d as cn, e as useNavigate, f as Sparkles, B as BookOpen, i as ue } from "./index-rRcYy_Bl.js";
import { E as ExternalBlob, B as Button, u as useActor, c as createActor, a as Badge, C as ChevronRight, L as Layers } from "./badge-CrUbumsw.js";
import { X, I as Image, C as Clipboard, U as Upload, G as Globe, Z as Zap, a as CircleCheck, E as Eye, T as Target, A as ArrowRight, M as Monitor } from "./zap-BozFBTzf.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: [
        ...
        isDragging2 ? "border-primary bg-primary/10" : "border-border hover:border-primary/50 hover:bg-muted/30",
      ...
      onClick: () => {
        var _a2;
        return !disabled && ((_a2 = inputRef.current) == null ? void 0 : _a2.click());
      },
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-14 h-14 rounded-full bg-primary/10 border border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "w-7 h-7 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Supports PNG, JPG, WebP" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted/50 border border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clipboard, { className: "w-3.5 h-3.5 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "or paste from clipboard" })
        ] }),
...
function HomePage() {
  const [screenshotBlob, setScreenshotBlob] = reactExports.useState(
    null
  );
  const [previewUrl, setPreviewUrl] = reactExports.useState(null);
  const [taskGoal, setTaskGoal] = reactExports.useState("");
  const [platformName, setPlatformName] = reactExports.useState("");
  ...
  const mutateAsyncRef = reactExports.useRef(detectPlatform.mutateAsync);
  ...
  reactExports.useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        setTimeout(() => {
          var _a2;
          (_a2 = step3Ref.current) == null ? void 0 : _a2.scrollIntoView({
            behavior: "smooth",
            block: "center"
          });
        }, 400);
      } catch {
        ue.error("Could not detect platform. Please type it manually.");
      } finally {
        setDetecting(false);
      }
    };
  ...
  const handleUpload = (blob, url) => {
    setScreenshotBlob(blob);
    setPreviewUrl(url);
    setPlatformName("");
    setTimeout(() => {
      var _a2;
      (_a2 = step2Ref.current) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth", block: "center" });
    }, 200);
  };
  const handleGenerate = async () => {
    if (!screenshotBlob || !taskGoal.trim() || !platformName.trim()) return;
    try {
      const id2 = await generatePlaybook.mutateAsync({
        screenshot: screenshotBlob,
        taskGoal: taskGoal.trim(),
        platformName: platformName.trim()
      });
      navigate({ to: "/playbook/$id", params: { id: id2.toString() } });
    } catch {
      ue.error("Failed to generate playbook. Please try again.");
    }
  };
  const isReady = !!screenshotBlob && taskGoal.trim().length > 0 && platformName.trim().length > 0 && !detecting;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[calc(100vh-4rem)] bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-card border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            backgroundImage: "linear-gradient(var(--color-border,#334) 1px,transparent 1px),linear-gradient(90deg,var(--color-border,#334) 1px,transparent 1px)",
            backgroundSize: "32px 32px"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute -top-32 left-1/2 -translate-x-1/2 w-[900px] h-[420px] rounded-full bg-primary/10 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
          ...
          motion.h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary relative", children: [
                "Studio",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 right-0 h-px bg-gradient-to-r from-primary/0 via-primary to-primary/0" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.p,
          {
            ...
            children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "step-by-step visual guide" }),
              " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground mr-1", children: "Works with" }),
              PLATFORMS.map(({ name, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-2xl mx-auto px-4 sm:px-6 py-12 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 px-6 pt-6 pb-4 border-b border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "step-badge", children: "1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-subheading text-foreground", children: "Upload Screenshot" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Drag & drop, paste (Ctrl+V), or click to browse" })
              ] })
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: screenshotBlob && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ref: step2Ref,
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 px-6 pt-6 pb-4 border-b border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "step-badge", children: "2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-subheading text-foreground", children: "Platform Detected" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "AI is analyzing your screenshot" })
              ] }),
              detecting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3.5 h-3.5 border-2 border-primary border-t-transparent rounded-full animate-spin" }),
                    "Detecting…"
                  ]
                }
              ) : platformName ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformIcon, { className: "w-3.5 h-3.5" }),
                    platformName,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
              previewUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-border/60 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: previewUrl,
                  alt: "Uploaded screenshot",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 bg-muted/30 rounded-xl border border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "Platform name (editable)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "platform",
                      ...
                      placeholder: detecting ? "Detecting…" : "e.g. GitHub, Lovable, Figma…",
                ...
                platformName && /* @__PURE__ */ jsxRuntimeExports.jsx(PlatformIcon, { className: "w-4 h-4 text-primary flex-shrink-0" })
              ] })
            ] })
          ]
        },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: screenshotBlob && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 px-6 pt-6 pb-4 border-b border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "step-badge", children: "3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-subheading text-foreground", children: "What do you want to accomplish?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Describe the task for this walkthrough guide" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-label", children: "Quick examples" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: EXAMPLE_GOALS.map((ex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: screenshotBlob && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 px-6 pt-6 pb-4 border-b border-border/50", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "step-badge", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WandSparkles, { className: "w-5 h-5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-subheading text-foreground", children: "Generate Playbook" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "AI will create a full step-by-step visual guide" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
              ...
              ].map(({ label, done, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex items-center gap-2 px-3 py-2.5 rounded-xl border text-xs transition-smooth ${done ? "border-primary/40 bg-primary/8 text-primary" : "border-border bg-muted/20 text-muted-foreground"}`,
                  children: [
                    ...
                    done && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3 h-3 ml-auto" })
                  ]
                },
                label
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: generatePlaybook.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 border-2 border-primary-foreground border-t-transparent rounded-full animate-spin" }),
              ...
              !isReady && !generating(
                ...
                "p",
                {
                  ...
                  children: !screenshotBlob ? "↑ Upload a screenshot to begin" : detecting ? "⏳ Detecting platform…" : !platformName.trim() ? "Enter the platform name above" : "Describe your goal to continue"
                }
              )
            ] })
          ]
      ...
      !screenshotBlob && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-muted/40 border border-border mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-6 h-6 text-muted-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Your playbook will appear here" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Upload a screenshot above to get started" })
            ] }),
...
function generating(screenshot, detecting, taskGoal, platformName) {
  return !!screenshot && !detecting && !!taskGoal.trim() && !!platformName.trim();
}
export {
  HomePage as default
};
